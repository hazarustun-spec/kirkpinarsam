const T = {
  tr: {
    ...
    hero_sub: "Sapanca Kırkpınar'da sahibinden iki özel arsa — tapu hazır, hızlı devir.",
    hero_cta_wa: "Sapanca Arsa Hakkında WhatsApp",
    ...
    wa_msg: "Merhaba, Sapanca Kırkpınar'daki satılık arsa hakkında bilgi almak istiyorum.",
  ...
  en: {
    ...
    hero_sub: "Sapanca Kırkpınar — direct from owner, title ready, fast transfer.",
    hero_cta_wa: "WhatsApp about Sapanca Land",
    ...
    wa_msg: "Hello, I would like to get information about the land for sale in Sapanca Kırkpınar.",
    back: "Back to Home",
  ...
  ar: {
    ...
    wa_msg: "مرحباً، أود الحصول على معلومات حول الأرض المعروضة للبيع في سابانجا كيركبينار.",
